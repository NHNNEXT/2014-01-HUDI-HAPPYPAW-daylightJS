...
test("CORE", function() {
	...
	equal(1, daylight.index(dl_div.o, p), "index test");
	equal(0, daylight.index(dl_div.o, div), "index test");
	equal(-1, daylight.index(dl_div.o, ""), "index test");
...
test("is test", function() {
	...
	//ok(daylight.isNode(document.querySelector("body")));
